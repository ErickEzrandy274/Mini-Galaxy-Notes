				...
				<BaseAuth title="Register">
					<form onSubmit={handleSubmit}>
						...
						<div className="mt-4">
							...
							<input
								id="password"
								className="block w-full px-4 py-2 bg-white border rounded-md text-gray-300 :border-gray-600 focus:ring-opacity-50 focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-500"
								type="password"
								onChange={handleChange}
							/>
						</div>
